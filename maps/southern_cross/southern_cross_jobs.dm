...
/datum/job/explorer
	...
	economic_modifier = 5
	access = list(access_pilot, access_explorer, access_research)
...
/datum/job/sar
	...
	economic_modifier = 5
	access = list(access_medical, access_medical_equip, access_morgue, access_surgery, access_chemistry, access_virology, access_eva, access_maint_tunnels, access_external_airlocks, access_psychiatrist, access_pilot, access_explorer)
	minimal_access = list(access_medical, access_medical_equip, access_morgue, access_pilot, access_explorer)
