...
MITHRAStation is a fork of the VOREStation code branch, that is a fork of the Polaris branch, which itself a fork of the Baystation12 code branch, for the game Space Station 13.

---

### LICENSE
The code for MITHRAStation is licensed under the [GNU Affero General Public License](http://www.gnu.org/licenses/agpl.html) version 3, which can be found in full in LICENSE-AGPL3.txt.
