/*
//	ALL OF MITHRA'S ADDITIONS TO HEAD LOADOUT ITEMS GO HERE
*/

//Black Bandana, requested by NIIM

/datum/gear/head/bandana_black
...
//Maid Hat, requested by Greenie

/datum/gear/head/maid_hat
