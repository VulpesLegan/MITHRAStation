/*
	Main gun code for the Multiphase port goes here
*/

/obj/item/weapon/gun/energy/gun/multiphase
	name = "\improper X-01 MultiPhase Energy Gun"
	desc = "This is an expensive, modern recreation of an antique laser gun. This gun has several unique firemodes, but lacks the ability to recharge over time."
	icon = 'modular_mithra/multiphase/multiphase.dmi'
	item_icons = list(
		slot_l_hand_str = 'modular_mithra/multiphase/left.dmi',
		slot_r_hand_str = 'modular_mithra/multiphase/right.dmi',
		)
