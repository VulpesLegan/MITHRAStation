...
/obj/item/toy/tennis
	...
	icon = 'modular_mithra/icons/obj/balls.dmi'
	icon_state = "tennis_classic"
	item_icons = list(
		slot_l_hand_str = 'modular_mithra/icons/mob/inhands/balls_left.dmi',
		slot_r_hand_str = 'modular_mithra/icons/mob/inhands/balls_right.dmi'
		)
	...
	icon_override = 'modular_mithra/icons/mob/mouthball.dmi'
	w_class = ITEMSIZE_SMALL
	attack_verb = list("squished", "squashed", "hit", "bonked")
